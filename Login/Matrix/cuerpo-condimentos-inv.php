...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <center><button type="button" class="btn-close btn btn-danger btn-sm" data-dismiss="modal" onclick="location.href='principal-condimentos-inv.php'" style="max-width: 10rem;" >
          ...
          <a href ="reporte/inventario-condimento.php" target="_blank">
...
<?php
$query = 'SELECT * FROM inv_condimento ';

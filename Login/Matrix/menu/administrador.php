...
<nav class="navbar navbar-expand-md navbar-white   sticky-top">
      ...
      <div class=" collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mx-auto">
                  ...
                  <button class="mr-3 btn btn-info btn-sm" onclick="location.href='principal-usuario.php'">Usuario</button>
                  ...
                  <button class="mr-3 btn btn-info btn-sm" onclick="location.href='principal-graficas.php'">Graficas</button>

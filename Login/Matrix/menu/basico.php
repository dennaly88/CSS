...
<nav class="navbar navbar-expand-md navbar-white   sticky-top">
      ...
      <div class=" collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mx-auto">
                  ...
                  <a href="http://intranet.vtv.gov.ve/intranet/principal/paginas/classIndex.php" target=" _blank" onclick="window.open(this.href, this.target, 'width=1000,height=1000'); return false;">

                        <button class="mr-3 btn btn-info btn-sm"> Intranet</button>



                        <a href="https://vtvcorreo.vtv.gob.ve/" target=" _blank" onclick="window.open(this.href, this.target, 'width=1000,height=1000'); return false;">

                              <button class="mr-3 btn btn-info btn-sm">Correo</button>

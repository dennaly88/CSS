  ...
  <center>
    <div class="card border-secondary mb-3" style="max-width: 80rem;">
      <div class="card-header card text-white bg-secondary mb-3">
        ...
        <center><button type="button" class="btn-close btn btn-danger btn-sm" data-dismiss="modal" onclick="location.href='principal-charcuteria.php'" style="max-width: 10rem;">
            <span aria-hidden="true" class="text-light">Charcuteria</span>
          </button>
                  ...
                  <center>
                    ...
                    <center>
                                      ...
                                      <center>
                                        ...
                                        <center>
                                          <td>
                                            ...
                                            <a href="principal-eliminar-charcuteria.php?id=<?php echo $id; ?>">
                     ...
                     data-usu=" <?php echo $usu; ?>" data-pass="<?php echo $pass; ?>" data-per="<?php echo $per; ?>" data-cor="<?php echo $cor; ?>" data-nom="<?php echo $nom; ?>" data-ape="<?php echo $ape; ?>" data-tel="<?php echo $tel; ?>" data-ced="<?php echo $ced; ?>">
                                                ...
                                                <a href="principal-editar-charcuteria.php?id=<?php echo $id; ?>">

                                                  <button type='button' class='btn btn-info btn-sm' title="Editar"> &#x1f4dd; </button>


                                                  <a href="principal-aum-charcuteria.php?id=<?php echo $id; ?>">

                                                    <button type='button' class='btn btn-success btn-sm' title="Aumentar"> &#x2795; </button>


                                                    <a href="principal-dim-charcuteria.php?id=<?php echo $id; ?>">
    ...
    <a href="reporte/charcuteria.php" title="Stock de Charcuteria" target="_blank"> <button type="button" class="btn-close btn btn-danger btn-sm" data-dismiss="modal" style="max-width: 10rem;">

...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <center><button type="button" class="btn-close btn btn-danger btn-sm" data-dismiss="modal" onclick="location.href='principal-materiales-inv.php'" style="max-width: 10rem;" >
                      <span aria-hidden="true" class="text-light">Inventario Materiales</span>
                      </button>
          ...
          <a href ="reporte/inventario-materiales.php" target="_blank">
...
<?php
$query = 'SELECT * FROM inv_materiales ';

...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <center><button type="button" class="btn-close btn btn-danger btn-sm" data-dismiss="modal" onclick="location.href='principal-proteinas.php'" style="max-width: 10rem;" >
                      <span aria-hidden="true" class="text-white">Proteinas</span>
                      </button>
...
<a href="principal-eliminar-proteina.php?id=<?php echo $id;?>"> 
...
<!--_____________________________________BOTON EDITAR_________________________________________________________________-->
                       ...
                       <a href="principal-editar-proteina.php?id=<?php echo $id;?>"> 
       ...
       <a href="principal-aum-proteina.php?id=<?php echo $id;?>"> 
      
      <button type= 'button' class= 'btn btn-success btn-sm'  title="Aumentar"> &#x2795; </button>


      <a href="principal-dim-proteina.php?id=<?php echo $id;?>"> 
...
<span aria-hidden="true">Agregar Proteinas</span>
              </div>
                              <div class="modal-body">
                                <div class="card border mb-3" style="max-width: 50rem;">
                                 <div class="card-body text-secondary">
           <center>
            <form method="post"  action="sql/crear-proteinas.php">
                                  ...
                                  <?php     
                                              ...
                                              $query = 'SELECT * FROM tipo_proteina;';
...
<a href="reporte/proteinas.php" title="Stock" target="_blank">  <button type="button" class="btn-close btn btn-danger btn-sm" data-dismiss="modal" 

...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <center><button type="button" class="btn-close btn btn-dark btn-sm" data-dismiss="modal" onclick="location.href='principal-materiales.php'" style="max-width: 10rem;" >
                      <span aria-hidden="true" class="text-white">Materiales</span>
                      </button>
...
<a href="principal-eliminar-materiales.php?id=<?php echo $id;?>"> 
...
<!--_____________________________________BOTON EDITAR_________________________________________________________________-->
                       ...
                       <a href="principal-editar-materiales.php?id=<?php echo $id;?>"> 
       ...
       <a href="principal-aum-materiales.php?id=<?php echo $id;?>"> 
      
      <button type= 'button' class= 'btn btn-success btn-sm'  title="Aumentar"> &#x2795; </button>


      <a href="principal-dim-materiales.php?id=<?php echo $id;?>"> 
...
<span aria-hidden="true">Agregar Material</span>
              </div>
                              <div class="modal-body">
                                <div class="card border mb-3" style="max-width: 50rem;">
                                 <div class="card-body text-secondary">
           <center>
            <form method="post"  action="sql/crear-materiales.php">
...
<a href="reporte/materiales.php" title="Stock" target="_blank">  <button type="button" class="btn-close btn btn-dark btn-sm" data-dismiss="modal" 

...
?>
    ...
    <div class="modal fade" id="danny" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                     ...
                     <span aria-hidden="true">Vas a Disminuir el Condimento</span>
                      </button>
                      </h5>  
                              </div>
           ...
           <center>
            <form method="post"  action="sql/dim-condimento.php">
...
Cantidad A Disminuir <input class="form-control form-control-sm" type="number"   max="<?php echo $row['cantidad'] ?>" name="edit_cantidad_nueva"  id="edit_cantidad_nueva" placeholder="" value="" required >
Fecha<input class="form-control form-control-sm" type="text" readonly name="edit_fecha" id="edit_fecha" placeholder="" value="  <?php

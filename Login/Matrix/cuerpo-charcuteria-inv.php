...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <center><button type="button" class="btn-close btn btn-danger btn-sm" data-dismiss="modal" onclick="location.href='principal-charcuteria-inv.php'" style="max-width: 10rem;" >
                      <span aria-hidden="true" class="text-light">Inventario Charcuteria</span>
                      </button>
          ...
          <a href="reporte/inventario-charcuteria.php" title="Stock" target="_blank">  <button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal" 
...
<?php
$query = 'SELECT * FROM inv_charcuteria ';

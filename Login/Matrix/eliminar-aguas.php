...
<head>
    ...
    $query = "SELECT * FROM agua WHERE id ='$id'";
            ...
            <div class="modal-content">
                <div class="modal-header btn btn-secondary">
                    <h5 class="modal-title" id="exampleModalLabel"><button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal">
                            <span aria-hidden="true">Eliminar Botellones</span>
                        </button>
                ...
                <div class="modal-body">
                    <div class="card border mb-3" style="max-width: 50rem;">
                        <div class="card-body text-secondary">
                            ...
                            <center>
                                <form method="post" action="sql/eliminar-aguas.php?id=<?php echo $id; ?>">
                                    ...
                                    Gerencia<input class="form-control form-control-sm" type="text" name="edit_nombre" id="edit_nombre" readonly placeholder="usuario" value="<?php echo $row['gerencia'] ?>" required>
                                    Botellones<input class="form-control form-control-sm" type="text" name="edit_unidad" id="edit_unidad" readonly placeholder="unidad" value="<?php echo $row['cantidad'] ?>" required>
                                    Fecha<input class="form-control form-control-sm" type="text" name="edit_cantidad" id="edit_cantidad" readonly placeholder="cantidad" value="<?php echo $row['fecha'] ?>" required>
                                    ...
                                    Accion<br><input class="form-control form-control-sm" type="text" name="edit_fecha" id="edit_fecha" readonly placeholder="fecha" value="  <?php

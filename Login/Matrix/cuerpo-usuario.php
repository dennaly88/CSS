  ...
  <center>
    <div class="card border-secondary mb-3" style="max-width: 80rem;">
      <div class="card-header card text-white bg-secondary mb-3">
        ...
        <center><button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal" onclick="location.href='principal-usuario.php'" style="max-width: 10rem;">
            <span aria-hidden="true" class="text-light">Usuarios</span>
          </button>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control form-control-sm" placeholder name="per" required>
                        ...
                        while ($fila = pg_fetch_array($resulatdo)) {
                          echo "<option values" . $fila['id'] . ">" . $fila['perfil'] . "</option>";
                        }
                        ?>
                      </select>
                    </div>

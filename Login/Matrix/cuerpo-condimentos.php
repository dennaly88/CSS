...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <center><button type="button" class="btn-close btn btn-success btn-sm" data-dismiss="modal" onclick="location.href='principal-condimentos.php'" style="max-width: 10rem;" >
                      <span aria-hidden="true" class="text-light">Condimentos</span>
                      </button>
...
<a href="principal-eliminar-condimento.php?id=<?php echo $id;?>"> 
...
<!--_____________________________________BOTON EDITAR_________________________________________________________________-->
                       ...
                       <a href="principal-editar-condimentos.php?id=<?php echo $id;?>"> 
       ...
       <a href="principal-aum-condimento.php?id=<?php echo $id;?>"> 
      
      <button type= 'button' class= 'btn btn-success btn-sm'  title="Aumentar"> &#x2795; </button>


      <a href="principal-dim-condimento.php?id=<?php echo $id;?>"> 
...
<!--__________________________________________________________________________________________________________________-->
                      ...
                      <span aria-hidden="true">Agregar Condimento</span>
                      </button>
                      </h5>  
                              </div>
...
<span aria-hidden="true">Agregar Condimento</span>
                              ...
                              <div class="modal-body">
                                <div class="card border mb-3" style="max-width: 50rem;">
                                 <div class="card-body text-secondary">
           <center>
            <form method="post"  action="sql/crear-condimento.php">
                                  ...
                                  <?php     
                                              ...
                                              $query = 'SELECT * FROM tipo_condimento;';
...
<div class="form-group" id="nombre">
               ...
               <label for="recipient-name" class="col-form-label">Unidad</label>
                 <select class="form-control form-control-sm" placeholder name="unidad" required>
                    ...
                    Cantidad<input class="form-control form-control-sm" type="number" name="cantidad" id="cantidad" placeholder="" value="<?php echo  "    " . $_SESSION['usuario']; ?>" required >
                    Usuario<input class="form-control form-control-sm" type="text"  readonly name="usuario" id="usuario" placeholder="" value="<?php echo  "    " . $_SESSION['usuario']; ?>" required >
...
?>" required >
                              ...
                              Accion<input class="form-control form-control-sm" type="text" name="accion" readonly id="accion" placeholder="" value="Entrada" required >
...
<a href="reporte/condimento.php" title="Stock" target="_blank">  <button type="button" class="btn-close btn btn-success btn-sm" data-dismiss="modal" 

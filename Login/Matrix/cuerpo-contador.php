...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <center><button type="button" class="btn-close btn btn-dark btn-sm" data-dismiss="modal" onclick="location.href='principal-contador.php'" style="max-width: 10rem;" >
                      <span aria-hidden="true" class="text-white">Harinas</span>
                      </button>
...
<label for="recipient-name" class="col-form-label">Unidad</label>
  <select class="form-control form-control-sm" placeholder name="unidad" required>
        ...
        <option selected>Litros</option>
        <option selected>Rollos</option>
...
<a href="reporte/harinas.php" title="Stock" target="_blank">  <button type="button" class="btn-close btn btn-dark btn-sm" data-dismiss="modal" 

...
?>
    ...
    <div class="modal fade" id="danny8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <span aria-hidden="true">Eliminar la Comida</span>
                      </button>
           ...
           <center>
<form method="post"  action="sql/eliminar-comidas.php?id=<?php echo $id;?>">
...
Nombre<input class="form-control form-control-sm" type="text" name="edit_nombre" id="edit_nombre" readonly placeholder="usuario" value="<?php echo $row['gerencia'] ?>" required >
Unidad<input class="form-control form-control-sm" type="text" name="edit_unidad" id="edit_unidad" readonly placeholder="unidad" value="<?php echo $row['tipo'] ?>" required >

...
$edit_accion='Modificado';
     ...
     $query = "UPDATE hortaliza SET id='$edit_id', nombre='$edit_nombre', unidad='$edit_unidad',cantidad='$edit_cantidad', usuario='$edit_usuario' , 
     ...
     $query2 = "INSERT INTO inv_hortaliza(nombre,unidad,cantidad,usuario,fecha,accion) VALUES ('$edit_nombre','$edit_unidad','$edit_cantidad',
     '$edit_usuario','$edit_fecha','$edit_accion')";
...
header("Location: http:../principal-hortalizas.php?usu=2");

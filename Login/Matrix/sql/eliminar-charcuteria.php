...
$query2 = "INSERT INTO inv_charcuteria(nombre,fecha,unidad,usuario,cantidad,accion) VALUES ('$edit_nombre','$edit_fecha','$edit_unidad','$edit_usuario','$edit_cantidad','$edit_accion')";
...
$cmdtuples2 = pg_affected_rows($result2);
     ...
     $query = "DELETE FROM charcuteria WHERE id ='$id'";
     $result = pg_query($query) or die('Query failed: ' .pg_last_error());
          ...
          header("Location: http:../principal-charcuteria.php?usu=3");

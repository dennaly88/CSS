...
$edit_accion="Modificado";
     ...
     $query = "UPDATE charcuteria SET id='$edit_id', nombre='$edit_nombre', unidad='$edit_unidad',cantidad='$edit_cantidad',
     ...
     $query2 = "INSERT INTO inv_charcuteria(nombre,unidad,cantidad,usuario,fecha,accion) VALUES ('$edit_nombre','$edit_unidad','$edit_cantidad',
     '$edit_usuario','$edit_fecha','$edit_accion')";
...
header("Location: http:../principal-charcuteria.php?usu=2");

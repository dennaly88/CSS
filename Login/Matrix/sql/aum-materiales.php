...
$edit_cantidad=$edit_cantidad+$edit_cantidad_nueva;
     ...
     $query = "UPDATE materiales SET id='$edit_id', nombre='$edit_nombre', unidad='$edit_unidad',cantidad='$edit_cantidad',
...
header("Location: http:../principal-materiales.php?usu=4");

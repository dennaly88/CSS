...
?>
    ...
    <div class="modal fade" id="danny8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           ...
           <center>
            <form method="post"  action="sql/eliminar-inventario.php?id=<?php echo $id;?>">
...
?>" required >
Accion<br><input class="form-control form-control-sm" type="text" name="edit_accion" id="edit_accion" readonly placeholder="nombre" value="<?php echo $row['usuario'] ?>" required >

            ...
            <div class="modal-content">
                <div class="modal-header btn btn-secondary">
                    <h5 class="modal-title" id="exampleModalLabel"><button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal">
                            <span aria-hidden="true">Editar Agua</span>
                        </button>
                    </h5>
                </div>
                <div class="modal-body">
                    <div class="card border mb-3" style="max-width: 50rem;">
                        <div class="card-body text-secondary">
                            <center>
                                <form method="post" action="sql/modificar-aguas.php">
                                    ...
                                    Gerencia<input class="form-control form-control-sm" type="text" readonly name="edit_gerencia" id="edit_gerencia" placeholder="nombre" value="<?php echo $row['gerencia'] ?>" required>
                                    Usuario<input class="form-control form-control-sm" type="text" name="edit_usuario" id="edit_usuario" placeholder="usuario" value="<?php echo $row['usuario'] ?>" required>

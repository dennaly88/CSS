  ...
  <center>
    <div class="card border-secondary mb-3" style="max-width: 80rem;">
      <div class="card-header card text-white bg-secondary mb-3">
        ...
        <center><button type="button" class="btn-close btn btn-danger btn-sm" data-dismiss="modal" onclick="location.href='principal-inventario-general.php'" style="max-width: 10rem;">
            <span aria-hidden="true" class="text-light">Inventario General</span>
          </button>
      ...
      <div class="card-body text-secondary">
        ...
        <a href="reporte/inventario-general.php" title="Stock" target="_blank"> <button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal" style="max-width: 10rem;">
                  ...
                  <center>
                    ...
                    <center>
                     ...
                     data-usu=" <?php echo $usu; ?>" data-pass="<?php echo $pass; ?>" data-per="<?php echo $per; ?>" data-cor="<?php echo $cor; ?>" data-nom="<?php echo $nom; ?>" data-ape="<?php echo $ape; ?>" data-tel="<?php echo $tel; ?>" data-ced="<?php echo $ced; ?>">
                                              ...
                                              <a href="sql/principal-eliminar-inventaior.php?id=<?php echo $id; ?>">

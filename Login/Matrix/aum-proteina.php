      ...
      <div class="modal-content">
        <div class="modal-header btn btn-secondary">
          <h5 class="modal-title" id="exampleModalLabel"><button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal">
              <span aria-hidden="true">Vas a Aumentar la Proteina</span>
            </button>
          </h5>
        </div>
        <div class="modal-body">
          <div class="card border mb-3" style="max-width: 50rem;">
            <div class="card-body text-secondary">
              <center>
                <form method="post" action="sql/aum-proteina.php">
                  ...
                  Cantidad A Incrementar<input class="form-control form-control-sm" type="number" min="" name="edit_cantidad_nueva" id="edit_cantidad_nueva" placeholder="" value="" required>

...
<head>
  ...
  $query = "SELECT * FROM condimento WHERE id ='$id'";
      ...
      <div class="modal-content">
        <div class="modal-header btn btn-secondary">
          <h5 class="modal-title" id="exampleModalLabel"><button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal">
              <span aria-hidden="true">Editar El Condimento</span>
            </button>
          </h5>
        </div>
        <div class="modal-body">
          <div class="card border mb-3" style="max-width: 50rem;">
            <div class="card-body text-secondary">
              <center>
                <form method="post" action="sql/modificar-condimento.php">
                  ...
                  Cantidad<input class="form-control form-control-sm" type="text" name="edit_nombre" id="edit_nombre" readonly placeholder="cantidad" value="<?php echo $row['nombre'] ?>" required>
                  <?php
                  ...
                  Usuario<br><input class="form-control form-control-sm" type="text" name="edit_usuario" readonly id="edit_usuario" placeholder="usuario" value="<?php echo $row['usuario'] ?>" required>
                  Fecha<br><input class="form-control form-control-sm" type="text" name="edit_fecha" id="edit_fecha" readonly placeholder="fecha" value="<?php
                                                                                                                                                          ...
                                                                                                                                                          ?>" required>
                  Accion<br><input class="form-control form-control-sm" type="text" name="edit_accion" id="edit_accion" readonly placeholder="accion" value="<?php echo $row['accion'] ?>" required>
            </div>
          </div>
        </div>

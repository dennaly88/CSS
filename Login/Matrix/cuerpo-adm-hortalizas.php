...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <center><button type="button" class="btn-close btn btn-primary btn-sm" data-dismiss="modal" onclick="location.href='adm-hortalizas.php'" style="max-width: 10rem;" >
                      <span aria-hidden="true" class="text-white">Tipo Hortalizas</span>
                      </button>
...
<a href="principal-eliminar-tipo-hortalizas.php?id=<?php echo $id;?>"> 
...
<span aria-hidden="true">Agregar Tipo de Hortalizas</span>
              </div>
                              <div class="modal-body">
                                <div class="card border mb-3" style="max-width: 50rem;">
                                 <div class="card-body text-secondary">
           <center>
            <form method="post"  action="sql/crear-tipo-hortalizas.php">

...
$query = "SELECT * FROM tipo_material WHERE id ='$id'";
...
?>
    ...
    <div class="modal fade" id="danny8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <span aria-hidden="true">Deseas Eliminar el Tipo de  Material</span>
                      </button>
           ...
           <center>
            <form method="post"  action="sql/eliminar-tipo-material.php?id=<?php echo $id;?>">

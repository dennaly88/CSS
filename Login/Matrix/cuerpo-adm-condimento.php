...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <center><button type="button" class="btn-close btn btn-primary btn-sm" data-dismiss="modal" onclick="location.href='adm-charcuteria.php'" style="max-width: 10rem;" >
                      <span aria-hidden="true" class="text-white">Tipo Condimentos</span>
                      </button>
...
<a href="principal-eliminar-tipo-condimento.php?id=<?php echo $id;?>"> 
...
<span aria-hidden="true">Agregar Tipo de Condimento</span>
              </div>
                              <div class="modal-body">
                                <div class="card border mb-3" style="max-width: 50rem;">
                                 <div class="card-body text-secondary">
           <center>
            <form method="post"  action="sql/crear-tipo-condimento.php">

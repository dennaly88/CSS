      ...
      <div class="modal-content">
        <div class="modal-header btn btn-secondary">
          <h5 class="modal-title" id="exampleModalLabel"><button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal">
              <span aria-hidden="true">Editar Viveres</span>
            </button>
          </h5>
        </div>
        <div class="modal-body">
          <div class="card border mb-3" style="max-width: 50rem;">
            <div class="card-body text-secondary">
              <center>
                <form method="post" action="sql/modificar-viveres.php">
                  ...
                  <div class="form-group">
                    Nombre<input class="form-control form-control-sm" type="text" name="edit_nombre" readonly id="edit_nombre" placeholder="nombre" value="<?php echo $row['nombre'] ?>" required>
